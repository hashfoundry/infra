...
1. **Основы** - Введение в Kubernetes, базовые концепции
2. **Архитектура** - Компоненты кластера и их взаимодействие
3. **Pod'ы** - Управление контейнерами и их жизненным циклом
4. **Сети** - Сервисы, Ingress, сетевая модель
5. **Развертывание** - Стратегии деплоя и управление приложениями
6. **Конфигурация** - ConfigMaps, Secrets, управление настройками
7. **Хранение** - Persistent Volumes, StorageClass, резервное копирование
8. **Безопасность** - RBAC, Pod Security, сетевая безопасность
9. **Планирование** - Размещение Pod'ов, автомасштабирование
10. **Мониторинг** - Метрики, логи, алертинг
11. **Диагностика** - Отладка и решение проблем
12. **Сети (продвинутое)** - CNI, Service Mesh, микросегментация
13. **Расширение** - CRDs, Operators, кастомизация Kubernetes
